 ...
 * config/sports.ts
 * ─────────────────────────────────────────────────────────────────
 * F1 calendar (update once per year in December) and football competition IDs.
 * football-data.org free tier: Premier League (PL) + Champions League (CL) ONLY.
 */
...
export const FOOTBALL_COMPETITIONS = {
  PL: 'PL', // Premier League — free tier ✅
  CL: 'CL', // Champions League — free tier ✅
} as const;
